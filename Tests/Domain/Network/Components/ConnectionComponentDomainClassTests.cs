...
[TestClass] public abstract class ConnectionComponentDomainClassTests<TDomain, TData> 
    : SealedTests<TDomain, ConnectionComponentEntity<TData>> where TData : ConnectionComponentData, new() where TDomain : ConnectionComponentEntity<TData> {
    private TData? _data;
